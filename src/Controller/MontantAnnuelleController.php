...
class MontantAnnuelleController extends AbstractController
{
    ...
    {
        return $this->render('montant_annuelle/index.html.twig', [
    ...
    public function new(Request $request): Response
    {
        ...
        return $this->render('montant_annuelle/new.html.twig', [
    ...
    {
        return $this->render('montant_annuelle/show.html.twig', [
            'montant_annuelle' => $montantAnnuelle,
        ]);
    }
    ...
    public function edit(Request $request, MontantAnnuelle $montantAnnuelle): Response
    {
        ...
        return $this->render('montant_annuelle/edit.html.twig', [
            'montant_annuelle' => $montantAnnuelle,
            'form' => $form->createView(),
        ]);
    }
