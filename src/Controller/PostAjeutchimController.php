...
class PostAjeutchimController extends AbstractController
{
    ...
    {
        return $this->render('post_ajeutchim/index.html.twig', [
    ...
    public function new(Request $request): Response
    {
        ...
        return $this->render('post_ajeutchim/new.html.twig', [
    ...
    {
        return $this->render('post_ajeutchim/show.html.twig', [
            'post_ajeutchim' => $postAjeutchim,
        ]);
    }
    ...
    public function edit(Request $request, PostAjeutchim $postAjeutchim): Response
    {
        ...
        return $this->render('post_ajeutchim/edit.html.twig', [
            'post_ajeutchim' => $postAjeutchim,
            'form' => $form->createView(),
        ]);
    }
