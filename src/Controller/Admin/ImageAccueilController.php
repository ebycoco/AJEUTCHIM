...
class ImageAccueilController extends AbstractController
{
    ...
    {
        return $this->render('admin/image_accueil/index.html.twig', [
    ...
    public function new(Request $request): Response
    {
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            ...
            $imageAccueil->setUser($this->getUser());
        ...
        return $this->render('admin/image_accueil/new.html.twig', [
    ...
    {
        return $this->render('admin/image_accueil/show.html.twig', [
            'image_accueil' => $imageAccueil,
        ]);
    }
    ...
    public function edit(Request $request, ImageAccueil $imageAccueil): Response
    {
        ...
        return $this->render('admin/image_accueil/edit.html.twig', [
            'image_accueil' => $imageAccueil,
            'form' => $form->createView(),
        ]);
    }
